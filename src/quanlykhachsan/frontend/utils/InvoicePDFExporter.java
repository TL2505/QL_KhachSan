...
public class InvoicePDFExporter {
    ...
    public static void exportPDF(Booking booking, Customer customer, Room room, java.util.List<quanlykhachsan.backend.model.ServiceUsage> usages, int days, double totalAmount) {
        ...
        try {
            ...
            Paragraph title = new Paragraph("HÓA ĐƠN THANH TOÁN (E-INVOICE)", new Font(bf, 18, Font.BOLD, BaseColor.BLACK));
            ...
            document.add(new Paragraph("Khách hàng: " + (customer != null ? customer.getFullName() : "N/A"), fontNormal));
            document.add(new Paragraph("Số điện thoại: " + (customer != null ? customer.getPhone() : "N/A"), fontNormal));
            document.add(new Paragraph("Thời gian Check-in: " + (booking.getCheckInDate() != null ? sdf.format(booking.getCheckInDate()) : "N/A"), fontNormal));
            ...
            document.add(new Paragraph(" "));
            Paragraph footer = new Paragraph("Cảm ơn quý khách và hẹn gặp lại!", new Font(bf, 14, Font.ITALIC, BaseColor.DARK_GRAY));
