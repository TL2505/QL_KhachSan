            ...
            SwingWorker<String, Void> worker = new SwingWorker<>() {
                ...
                protected String doInBackground() {
                    ...
                    if (finalPointsRedeem > 0) {
                        boolean ok = LoyaltyAPI.redeemPoints(bKeep.getCustomerId(), finalPointsRedeem, finalLoyaltyDiscount, "Đổi điểm tại hóa đơn #" + bKeep.getId());
                        if (!ok) return "Error: Không thể đổi điểm Loyalty!";
                    }
